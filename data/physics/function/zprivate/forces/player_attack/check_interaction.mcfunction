...
data remove entity @s attack
    ...
    # Transform the unit ray from the player's eyes to the object's local coordinates
        ...
        execute store result score #Physics.Maths.RayPos.x Physics.Value store result score #Physics.Maths.RayPosOriginal.x Physics.Value run data get storage physics:temp data.PlayerAttack.RayPos[0] 1000
        execute store result score #Physics.Maths.RayPos.y Physics.Value store result score #Physics.Maths.RayPosOriginal.y Physics.Value run data get storage physics:temp data.PlayerAttack.RayPos[1] 1000
        execute store result score #Physics.Maths.RayPos.z Physics.Value store result score #Physics.Maths.RayPosOriginal.z Physics.Value run data get storage physics:temp data.PlayerAttack.RayPos[2] 1000
        ...
        # Get ray direction
        execute store result score #Physics.Maths.RayDirection.x Physics.Value run data get storage physics:temp data.PlayerAttack.RayDirection[0] 10000
        execute store result score #Physics.Maths.RayDirection.y Physics.Value run data get storage physics:temp data.PlayerAttack.RayDirection[1] 10000
        execute store result score #Physics.Maths.RayDirection.z Physics.Value run data get storage physics:temp data.PlayerAttack.RayDirection[2] 10000
    ...
    scoreboard players operation #Physics.Maths.RayDirection.x Physics.Value /= #Physics.Constants.10 Physics.Value
    scoreboard players operation #Physics.Maths.RayDirection.x Physics.Value *= #Physics.Maths.RayIntersection.Earliest Physics.Value
    scoreboard players operation #Physics.Maths.RayPosOriginal.x Physics.Value *= #Physics.Constants.1000 Physics.Value
    execute store result storage physics:temp data.IntersectionPos[0] double 0.000001 run scoreboard players operation #Physics.Maths.RayPosOriginal.x Physics.Value += #Physics.Maths.RayDirection.x Physics.Value

    scoreboard players operation #Physics.Maths.RayDirection.y Physics.Value /= #Physics.Constants.10 Physics.Value
    scoreboard players operation #Physics.Maths.RayDirection.y Physics.Value *= #Physics.Maths.RayIntersection.Earliest Physics.Value
    scoreboard players operation #Physics.Maths.RayPosOriginal.y Physics.Value *= #Physics.Constants.1000 Physics.Value
    execute store result storage physics:temp data.IntersectionPos[1] double 0.000001 run scoreboard players operation #Physics.Maths.RayPosOriginal.y Physics.Value += #Physics.Maths.RayDirection.y Physics.Value

    scoreboard players operation #Physics.Maths.RayDirection.z Physics.Value /= #Physics.Constants.10 Physics.Value
    scoreboard players operation #Physics.Maths.RayDirection.z Physics.Value *= #Physics.Maths.RayIntersection.Earliest Physics.Value
    scoreboard players operation #Physics.Maths.RayPosOriginal.z Physics.Value *= #Physics.Constants.1000 Physics.Value
    execute store result storage physics:temp data.IntersectionPos[2] double 0.000001 run scoreboard players operation #Physics.Maths.RayPosOriginal.z Physics.Value += #Physics.Maths.RayDirection.z Physics.Value

    # Display a crit particle at the intersection coordinates
    tp 0-0-0-0-0 @s
    data modify entity 0-0-0-0-0 Pos set from storage physics:temp data.IntersectionPos
