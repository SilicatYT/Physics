...
execute if score #Physics.Contact.FeatureB Physics matches 13 run data modify storage physics:zprivate ContactGroups[-1].Objects[0].Blocks[-1].Hitboxes[-1].Contacts[-1].ContactNormal[1] set value 1000
