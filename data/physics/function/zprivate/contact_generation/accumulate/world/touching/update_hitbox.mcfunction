...
execute unless score #Physics.Contact.FeatureA Physics = #Physics.FeatureA Physics run function physics:zprivate/contact_generation/accumulate/world/touching/update_contact/main
execute if score #Physics.Contact.FeatureA Physics = #Physics.FeatureA Physics unless score #Physics.Contact.FeatureB Physics = #Physics.FeatureB Physics run function physics:zprivate/contact_generation/accumulate/world/touching/update_contact/main
...
execute unless score #Physics.Contact.FeatureA Physics = #Physics.FeatureA Physics run return run function physics:zprivate/contact_generation/accumulate/world/touching/update_contact/main
function physics:zprivate/contact_generation/accumulate/world/touching/update_contact/main
