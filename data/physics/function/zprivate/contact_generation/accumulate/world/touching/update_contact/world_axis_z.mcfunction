...
# Check if the contact should be discarded
    ...
    $execute if score #Physics.Contact.FeatureB Physics matches 14 run scoreboard players operation #Physics.PenetrationDepth Physics = @s Physics.Object.CornerPosGlobal.$(FeatureA).z
    ...
    $execute if score #Physics.Contact.FeatureB Physics matches 15 run scoreboard players operation #Physics.PenetrationDepth Physics -= @s Physics.Object.CornerPosGlobal.$(FeatureA).z
...
# Update the contact
    ...
    execute if score #Physics.Contact.FeatureB Physics matches 14 store result storage physics:temp data.NewContact.ContactPoint[2] int 1 store result score #Physics.ContactPoint.z Physics run scoreboard players get #Physics.Projection.Block.WorldAxis.z.Min Physics
    execute if score #Physics.Contact.FeatureB Physics matches 15 store success storage physics:temp data.NewContact.ContactNormal[2] int 1000 store result storage physics:temp data.NewContact.ContactPoint[2] int 1 store result score #Physics.ContactPoint.z Physics run scoreboard players get #Physics.Projection.Block.WorldAxis.z.Max Physics
...
execute if score #Physics.PointVelocity.z Physics >= @s Physics.Object.MinSeparatingVelocity run return 0
...
scoreboard players operation @s Physics.Object.MinSeparatingVelocity = #Physics.PointVelocity.z Physics
