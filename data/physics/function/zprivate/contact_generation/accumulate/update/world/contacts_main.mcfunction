...
# (Important): If the gametime is the same, it means the contact was generated during this tick, which means it's already up to date.
    # Contact 1
    ...
    execute unless score #Physics.Contact.Gametime Physics = #Physics.Gametime Physics run function physics:zprivate/contact_generation/accumulate/update/world/update_contact
