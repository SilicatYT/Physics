...
# (Important): I check which of the 8 corners' projection is the closest to the object's face.
    ...
    scoreboard players operation #Physics.Projection.VoxelCorner0.ObjectAxis.y Physics = #Physics.Projection.VoxelCornerBase0.ObjectAxis.y Physics
    scoreboard players operation #Physics.Projection.VoxelCorner1.ObjectAxis.y Physics = #Physics.Projection.VoxelCornerBase1.ObjectAxis.y Physics
    scoreboard players operation #Physics.Projection.VoxelCorner2.ObjectAxis.y Physics = #Physics.Projection.VoxelCornerBase2.ObjectAxis.y Physics
    scoreboard players operation #Physics.Projection.VoxelCorner3.ObjectAxis.y Physics = #Physics.Projection.VoxelCornerBase3.ObjectAxis.y Physics
    scoreboard players operation #Physics.Projection.VoxelCorner4.ObjectAxis.y Physics = #Physics.Projection.VoxelCornerBase4.ObjectAxis.y Physics
    scoreboard players operation #Physics.Projection.VoxelCorner5.ObjectAxis.y Physics = #Physics.Projection.VoxelCornerBase5.ObjectAxis.y Physics
    scoreboard players operation #Physics.Projection.VoxelCorner6.ObjectAxis.y Physics = #Physics.Projection.VoxelCornerBase6.ObjectAxis.y Physics
    scoreboard players operation #Physics.Projection.VoxelCorner7.ObjectAxis.y Physics = #Physics.Projection.VoxelCornerBase7.ObjectAxis.y Physics

    scoreboard players operation #Physics.Projection.VoxelCorner0.ObjectAxis.y Physics += #Physics.Projection.VoxelCenter.ObjectAxis.y Physics
    scoreboard players operation #Physics.Projection.VoxelCorner1.ObjectAxis.y Physics += #Physics.Projection.VoxelCenter.ObjectAxis.y Physics
    scoreboard players operation #Physics.Projection.VoxelCorner2.ObjectAxis.y Physics += #Physics.Projection.VoxelCenter.ObjectAxis.y Physics
    scoreboard players operation #Physics.Projection.VoxelCorner3.ObjectAxis.y Physics += #Physics.Projection.VoxelCenter.ObjectAxis.y Physics
    scoreboard players operation #Physics.Projection.VoxelCorner4.ObjectAxis.y Physics += #Physics.Projection.VoxelCenter.ObjectAxis.y Physics
    scoreboard players operation #Physics.Projection.VoxelCorner5.ObjectAxis.y Physics += #Physics.Projection.VoxelCenter.ObjectAxis.y Physics
    scoreboard players operation #Physics.Projection.VoxelCorner6.ObjectAxis.y Physics += #Physics.Projection.VoxelCenter.ObjectAxis.y Physics
    scoreboard players operation #Physics.Projection.VoxelCorner7.ObjectAxis.y Physics += #Physics.Projection.VoxelCenter.ObjectAxis.y Physics

    # Corner 0
    execute if score #Physics.ObjectA.Feature Physics matches 12 store result score #Physics.Maths.Value1 Physics store result score #Physics.Maths.Value2 Physics store result score #Physics.Maths.Value3 Physics store result score #Physics.Maths.Value4 Physics store result score #Physics.Maths.Value5 Physics store result score #Physics.Maths.Value6 Physics store result score #Physics.Maths.Value7 Physics run scoreboard players operation #Physics.MinPointDistance Physics = @s Physics.Object.ProjectionOwnAxis.y.Max
    execute if score #Physics.ObjectA.Feature Physics matches 13 store result score #Physics.Maths.Value1 Physics store result score #Physics.Maths.Value2 Physics store result score #Physics.Maths.Value3 Physics store result score #Physics.Maths.Value4 Physics store result score #Physics.Maths.Value5 Physics store result score #Physics.Maths.Value6 Physics store result score #Physics.Maths.Value7 Physics run scoreboard players operation #Physics.MinPointDistance Physics = @s Physics.Object.ProjectionOwnAxis.y.Min
    scoreboard players operation #Physics.MinPointDistance Physics -= #Physics.Projection.VoxelCorner0.ObjectAxis.y Physics
    ...
    # Corner 1
    scoreboard players operation #Physics.Maths.Value1 Physics -= #Physics.Projection.VoxelCorner1.ObjectAxis.y Physics
    ...
    # Corner 2
    scoreboard players operation #Physics.Maths.Value2 Physics -= #Physics.Projection.VoxelCorner2.ObjectAxis.y Physics
    ...
    # Corner 3
    scoreboard players operation #Physics.Maths.Value3 Physics -= #Physics.Projection.VoxelCorner3.ObjectAxis.y Physics
    ...
    # Corner 4
    scoreboard players operation #Physics.Maths.Value4 Physics -= #Physics.Projection.VoxelCorner4.ObjectAxis.y Physics
    ...
    # Corner 5
    scoreboard players operation #Physics.Maths.Value5 Physics -= #Physics.Projection.VoxelCorner5.ObjectAxis.y Physics
    ...
    # Corner 6
    scoreboard players operation #Physics.Maths.Value6 Physics -= #Physics.Projection.VoxelCorner6.ObjectAxis.y Physics
    ...
    # Corner 7
    scoreboard players operation #Physics.Maths.Value7 Physics -= #Physics.Projection.VoxelCorner7.ObjectAxis.y Physics
