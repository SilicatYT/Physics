...
execute if score #Physics.Projection.Voxel.ObjectAxis.z.Min Physics >= @s Physics.Object.ProjectionOwnAxis.z.Min run scoreboard players set #Physics.ObjectA.Feature Physics 14
