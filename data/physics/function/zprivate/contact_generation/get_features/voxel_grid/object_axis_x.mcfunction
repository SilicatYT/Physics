...
execute if score #Physics.ObjectA.Feature Physics matches 10 run scoreboard players operation #Physics.DeepestProjection Physics = #Physics.Projection.VoxelBase.ObjectAxis.x.Min Physics
execute if score #Physics.ObjectA.Feature Physics matches 11 run scoreboard players operation #Physics.DeepestProjection Physics = #Physics.Projection.VoxelBase.ObjectAxis.x.Max Physics
