...
execute if score @s Physics.Object.BoundingBoxGlobalMin.z >= #Physics.Projection.Voxel.WorldAxis.z.Min Physics run scoreboard players set #Physics.ObjectB.Feature Physics 14
execute if score @s Physics.Object.BoundingBoxGlobalMin.z < #Physics.Projection.Voxel.WorldAxis.z.Min Physics run scoreboard players set #Physics.ObjectB.Feature Physics 15
...
# (Important): I check which of the 8 corners' projection is the closest to the world-geometry voxel's face. Basically, I get the smallest distance coming from both directions for each point, and compare which point has the smallest distance.
    # Corner 0
    execute if score #Physics.ObjectB.Feature Physics matches 14 store result score #Physics.Maths.Value1 Physics store result score #Physics.Maths.Value2 Physics store result score #Physics.Maths.Value3 Physics store result score #Physics.Maths.Value4 Physics store result score #Physics.Maths.Value5 Physics store result score #Physics.Maths.Value6 Physics store result score #Physics.Maths.Value7 Physics run scoreboard players operation #Physics.MinPointDistance Physics = #Physics.Projection.Voxel.WorldAxis.z.Max Physics
    execute if score #Physics.ObjectB.Feature Physics matches 15 store result score #Physics.Maths.Value1 Physics store result score #Physics.Maths.Value2 Physics store result score #Physics.Maths.Value3 Physics store result score #Physics.Maths.Value4 Physics store result score #Physics.Maths.Value5 Physics store result score #Physics.Maths.Value6 Physics store result score #Physics.Maths.Value7 Physics run scoreboard players operation #Physics.MinPointDistance Physics = #Physics.Projection.Voxel.WorldAxis.z.Min Physics
    scoreboard players operation #Physics.MinPointDistance Physics -= @s Physics.Object.CornerPosGlobal.0.z
    ...
    # Corner 1
    scoreboard players operation #Physics.Maths.Value1 Physics -= @s Physics.Object.CornerPosGlobal.1.z
    ...
    # Corner 2
    scoreboard players operation #Physics.Maths.Value2 Physics -= @s Physics.Object.CornerPosGlobal.2.z
    ...
    # Corner 3
    scoreboard players operation #Physics.Maths.Value3 Physics -= @s Physics.Object.CornerPosGlobal.3.z
    ...
    # Corner 4
    scoreboard players operation #Physics.Maths.Value4 Physics -= @s Physics.Object.CornerPosGlobal.4.z
    ...
    # Corner 5
    scoreboard players operation #Physics.Maths.Value5 Physics -= @s Physics.Object.CornerPosGlobal.5.z
    ...
    # Corner 6
    scoreboard players operation #Physics.Maths.Value6 Physics -= @s Physics.Object.CornerPosGlobal.6.z
    ...
    # Corner 7
    scoreboard players operation #Physics.Maths.Value7 Physics -= @s Physics.Object.CornerPosGlobal.7.z
