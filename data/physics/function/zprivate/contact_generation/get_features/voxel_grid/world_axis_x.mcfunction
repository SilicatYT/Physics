...
execute if score #Physics.ObjectB.Feature Physics matches 10 run scoreboard players operation #Physics.DeepestProjection Physics = @s Physics.Object.BoundingBoxGlobalMin.x
execute if score #Physics.ObjectB.Feature Physics matches 11 run scoreboard players operation #Physics.DeepestProjection Physics = @s Physics.Object.BoundingBoxGlobalMax.x
