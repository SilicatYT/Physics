...
execute if score @s Physics.Object.BoundingBoxGlobalMin.x >= #Physics.Projection.Voxel.WorldAxis.x.Min Physics run scoreboard players set #Physics.ObjectB.Feature Physics 10
execute if score @s Physics.Object.BoundingBoxGlobalMin.x < #Physics.Projection.Voxel.WorldAxis.x.Min Physics run scoreboard players set #Physics.ObjectB.Feature Physics 11
...
# (Important): I check which of the 8 corners' projection is the closest to the world-geometry voxel's face. Basically, I get the smallest distance coming from both directions for each point, and compare which point has the smallest distance.
    # Corner 0
    execute if score #Physics.ObjectB.Feature Physics matches 10 store result score #Physics.Maths.Value1 Physics store result score #Physics.Maths.Value2 Physics store result score #Physics.Maths.Value3 Physics store result score #Physics.Maths.Value4 Physics store result score #Physics.Maths.Value5 Physics store result score #Physics.Maths.Value6 Physics store result score #Physics.Maths.Value7 Physics run scoreboard players operation #Physics.MinPointDistance Physics = #Physics.Projection.Voxel.WorldAxis.x.Max Physics
    execute if score #Physics.ObjectB.Feature Physics matches 11 store result score #Physics.Maths.Value1 Physics store result score #Physics.Maths.Value2 Physics store result score #Physics.Maths.Value3 Physics store result score #Physics.Maths.Value4 Physics store result score #Physics.Maths.Value5 Physics store result score #Physics.Maths.Value6 Physics store result score #Physics.Maths.Value7 Physics run scoreboard players operation #Physics.MinPointDistance Physics = #Physics.Projection.Voxel.WorldAxis.x.Min Physics
    scoreboard players operation #Physics.MinPointDistance Physics -= @s Physics.Object.CornerPosGlobal.0.x
    ...
    # Corner 1
    scoreboard players operation #Physics.Maths.Value1 Physics -= @s Physics.Object.CornerPosGlobal.1.x
    ...
    # Corner 2
    scoreboard players operation #Physics.Maths.Value2 Physics -= @s Physics.Object.CornerPosGlobal.2.x
    ...
    # Corner 3
    scoreboard players operation #Physics.Maths.Value3 Physics -= @s Physics.Object.CornerPosGlobal.3.x
    ...
    # Corner 4
    scoreboard players operation #Physics.Maths.Value4 Physics -= @s Physics.Object.CornerPosGlobal.4.x
    ...
    # Corner 5
    scoreboard players operation #Physics.Maths.Value5 Physics -= @s Physics.Object.CornerPosGlobal.5.x
    ...
    # Corner 6
    scoreboard players operation #Physics.Maths.Value6 Physics -= @s Physics.Object.CornerPosGlobal.6.x
    ...
    # Corner 7
    scoreboard players operation #Physics.Maths.Value7 Physics -= @s Physics.Object.CornerPosGlobal.7.x
