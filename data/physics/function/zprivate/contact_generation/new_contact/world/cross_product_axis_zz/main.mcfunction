...
execute if score #Physics.Projection.Block.CrossProductAxis.zz.Min Physics < #Physics.Projection.Object.CrossProductAxis.zz.Min Physics run scoreboard players operation #Physics.DeepestProjection Physics = #Physics.Projection.Object.CrossProductAxis.zz.Min Physics
    ...
    execute if score #Physics.DeepestProjection Physics = #Physics.Projection.ObjectCorner1.CrossProductAxis.zz Physics run function physics:zprivate/contact_generation/new_contact/world/cross_product_axis_zz/get_edge_a {Edge:209,StartCorner:2,EndCorner:3}
    ...
    execute if score #Physics.DeepestProjection Physics = #Physics.Projection.ObjectCorner5.CrossProductAxis.zz Physics run function physics:zprivate/contact_generation/new_contact/world/cross_product_axis_zz/get_edge_a {Edge:211,StartCorner:6,EndCorner:7}
...
execute if score #Physics.Projection.Block.CrossProductAxis.zz.Min Physics < #Physics.Projection.Object.CrossProductAxis.zz.Min Physics run scoreboard players operation #Physics.DeepestProjection Physics = #Physics.Projection.BlockBase.CrossProductAxis.zz.Max Physics
    ...
    execute if score #Physics.DeepestProjection Physics = #Physics.Projection.BlockCornerBase4.CrossProductAxis.zz Physics run function physics:zprivate/contact_generation/new_contact/world/cross_product_axis_zz/get_edge_b {Edge:210,StartCorner:4,x:"Max",y:"Max",z:"Min"}
...
execute if score #Physics.MinSeparatingVelocity Physics > #Physics.PointVelocity.y Physics store result storage physics:zprivate data.ContactGroups[0].MinSeparatingVelocity int 1 run scoreboard players operation #Physics.MinSeparatingVelocityTotal Physics = #Physics.PointVelocity.y Physics
