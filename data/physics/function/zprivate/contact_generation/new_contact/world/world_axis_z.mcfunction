...
execute if score @s Physics.Object.BoundingBoxGlobalMin.z < #Physics.Projection.Block.WorldAxis.z.Min Physics run scoreboard players set #Physics.ObjectB.Feature Physics 104
execute if score @s Physics.Object.BoundingBoxGlobalMin.z >= #Physics.Projection.Block.WorldAxis.z.Min Physics run scoreboard players set #Physics.ObjectB.Feature Physics 105
