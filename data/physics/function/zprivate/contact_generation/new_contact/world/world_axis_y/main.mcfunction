...
execute if score #Physics.ThisObject Physics.Object.BoundingBoxGlobalMin.y < #Physics.Projection.Block.WorldAxis.y.Min Physics store result storage physics:temp data.NewContact.FeatureB byte 1 store result storage physics:temp data.FeatureB byte 1 run scoreboard players set #Physics.FeatureB Physics 12
execute if score #Physics.ThisObject Physics.Object.BoundingBoxGlobalMin.y >= #Physics.Projection.Block.WorldAxis.y.Min Physics store result storage physics:temp data.NewContact.FeatureB byte 1 store result storage physics:temp data.FeatureB byte 1 run scoreboard players set #Physics.FeatureB Physics 13
...
execute if score #Physics.FeatureB Physics matches 12 run scoreboard players operation #Physics.DeepestProjection Physics = #Physics.ThisObject Physics.Object.BoundingBoxGlobalMax.y
execute if score #Physics.FeatureB Physics matches 13 run scoreboard players operation #Physics.DeepestProjection Physics = #Physics.ThisObject Physics.Object.BoundingBoxGlobalMin.y
    ...
    execute if score #Physics.DeepestProjection Physics = #Physics.ThisObject Physics.Object.CornerPosGlobal.0.y run function physics:zprivate/contact_generation/new_contact/world/world_axis_y/get_corner {Corner:0}
    execute if score #Physics.DeepestProjection Physics = #Physics.ThisObject Physics.Object.CornerPosGlobal.1.y run function physics:zprivate/contact_generation/new_contact/world/world_axis_y/get_corner {Corner:1}
    execute if score #Physics.DeepestProjection Physics = #Physics.ThisObject Physics.Object.CornerPosGlobal.2.y run function physics:zprivate/contact_generation/new_contact/world/world_axis_y/get_corner {Corner:2}
    execute if score #Physics.DeepestProjection Physics = #Physics.ThisObject Physics.Object.CornerPosGlobal.3.y run function physics:zprivate/contact_generation/new_contact/world/world_axis_y/get_corner {Corner:3}
    execute if score #Physics.DeepestProjection Physics = #Physics.ThisObject Physics.Object.CornerPosGlobal.4.y run function physics:zprivate/contact_generation/new_contact/world/world_axis_y/get_corner {Corner:4}
    execute if score #Physics.DeepestProjection Physics = #Physics.ThisObject Physics.Object.CornerPosGlobal.5.y run function physics:zprivate/contact_generation/new_contact/world/world_axis_y/get_corner {Corner:5}
    execute if score #Physics.DeepestProjection Physics = #Physics.ThisObject Physics.Object.CornerPosGlobal.6.y run function physics:zprivate/contact_generation/new_contact/world/world_axis_y/get_corner {Corner:6}
    execute if score #Physics.DeepestProjection Physics = #Physics.ThisObject Physics.Object.CornerPosGlobal.7.y run function physics:zprivate/contact_generation/new_contact/world/world_axis_y/get_corner {Corner:7}
...
# Calculate Penetration Depth, Contact Normal, Contact Point & Separating Velocity
    ...
    # (Important): Because the static object is now the one with the face, the result of the separating velocity is inverted.
        ...
        execute if score #Physics.FeatureB Physics matches 12 run scoreboard players operation #Physics.VelocityFromAcceleration.y Physics *= #Physics.Constants.-1 Physics
        ...
        execute if score #Physics.FeatureB Physics matches 13 run scoreboard players operation #Physics.PointVelocity.y Physics *= #Physics.Constants.-1 Physics
