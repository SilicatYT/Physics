...
execute if score #Physics.Projection.Block.CrossProductAxis.zy.Min Physics < #Physics.Projection.Object.CrossProductAxis.zy.Min Physics run scoreboard players operation #Physics.DeepestProjection Physics = #Physics.Projection.Object.CrossProductAxis.zy.Min Physics
    ...
    execute if score #Physics.DeepestProjection Physics = #Physics.Projection.ObjectCorner4.CrossProductAxis.zy Physics run function physics:zprivate/contact_generation/new_contact/world/cross_product_axis_zy/get_edge_a {Edge:206,StartCorner:2,EndCorner:6}
    execute if score #Physics.DeepestProjection Physics = #Physics.Projection.ObjectCorner5.CrossProductAxis.zy Physics run function physics:zprivate/contact_generation/new_contact/world/cross_product_axis_zy/get_edge_a {Edge:207,StartCorner:3,EndCorner:7}
...
execute if score #Physics.Projection.Block.CrossProductAxis.zy.Min Physics < #Physics.Projection.Object.CrossProductAxis.zy.Min Physics run scoreboard players operation #Physics.DeepestProjection Physics = #Physics.Projection.BlockBase.CrossProductAxis.zy.Max Physics
    ...
    execute if score #Physics.DeepestProjection Physics = #Physics.Projection.BlockCornerBase4.CrossProductAxis.zy Physics run function physics:zprivate/contact_generation/new_contact/world/cross_product_axis_zy/get_edge_b {Edge:210,StartCorner:4,x:"Max",y:"Max",z:"Min"}
