...
execute if score #Physics.Projection.Block.CrossProductAxis.yy.Min Physics < #Physics.Projection.Object.CrossProductAxis.yy.Min Physics run scoreboard players operation #Physics.DeepestProjection Physics = #Physics.Projection.Object.CrossProductAxis.yy.Min Physics
    ...
    # Set the feature
    execute if score #Physics.DeepestProjection Physics = #Physics.Projection.ObjectCorner0.CrossProductAxis.yy Physics run function physics:zprivate/contact_generation/new_contact/world/cross_product_axis_yy/get_edge_a {Edge:204,StartCorner:0}
    execute if score #Physics.DeepestProjection Physics = #Physics.Projection.ObjectCorner1.CrossProductAxis.yy Physics run function physics:zprivate/contact_generation/new_contact/world/cross_product_axis_yy/get_edge_a {Edge:205,StartCorner:1}
    execute if score #Physics.DeepestProjection Physics = #Physics.Projection.ObjectCorner2.CrossProductAxis.yy Physics run function physics:zprivate/contact_generation/new_contact/world/cross_product_axis_yy/get_edge_a {Edge:206,StartCorner:2}
    execute if score #Physics.DeepestProjection Physics = #Physics.Projection.ObjectCorner3.CrossProductAxis.yy Physics run function physics:zprivate/contact_generation/new_contact/world/cross_product_axis_yy/get_edge_a {Edge:207,StartCorner:3}
