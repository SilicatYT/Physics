...
execute if score @s Physics.Object.BoundingBoxGlobalMin.x < #Physics.Projection.Block.WorldAxis.x.Min Physics run scoreboard players set #Physics.ObjectB.Feature Physics 100
execute if score @s Physics.Object.BoundingBoxGlobalMin.x >= #Physics.Projection.Block.WorldAxis.x.Min Physics run scoreboard players set #Physics.ObjectB.Feature Physics 101
