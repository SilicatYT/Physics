...
$execute store result score #Physics.InvertValues Physics if score #Physics.Projection.Block.CrossProductAxis.x$(ObjectAxis).Min Physics >= #Physics.Projection.Object.CrossProductAxis.x$(ObjectAxis).Min Physics
