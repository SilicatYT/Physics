...
$execute store result score #Physics.InvertValues Physics if score #Physics.Projection.Block.CrossProductAxis.y$(ObjectAxis).Min Physics >= #Physics.Projection.Object.CrossProductAxis.y$(ObjectAxis).Min Physics
