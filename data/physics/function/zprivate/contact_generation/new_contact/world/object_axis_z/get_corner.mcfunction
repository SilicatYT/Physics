...
execute if score #Physics.ObjectA.Feature Physics matches 104 run return run scoreboard players operation #Physics.PenetrationDepth Physics -= @s Physics.Object.ProjectionOwnAxis.z.Min
