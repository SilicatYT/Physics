...
execute if score #Physics.ThisObject Physics.Object.BoundingBoxGlobalMin.x < #Physics.Projection.Block.WorldAxis.x.Min Physics store result storage physics:temp data.NewContact.FeatureB byte 1 store result storage physics:temp data.FeatureB byte 1 run scoreboard players set #Physics.FeatureB Physics 10
execute if score #Physics.ThisObject Physics.Object.BoundingBoxGlobalMin.x >= #Physics.Projection.Block.WorldAxis.x.Min Physics store result storage physics:temp data.NewContact.FeatureB byte 1 store result storage physics:temp data.FeatureB byte 1 run scoreboard players set #Physics.FeatureB Physics 11
...
execute if score #Physics.FeatureB Physics matches 10 run scoreboard players operation #Physics.DeepestProjection Physics = #Physics.ThisObject Physics.Object.BoundingBoxGlobalMax.x
execute if score #Physics.FeatureB Physics matches 11 run scoreboard players operation #Physics.DeepestProjection Physics = #Physics.ThisObject Physics.Object.BoundingBoxGlobalMin.x
    ...
    execute if score #Physics.DeepestProjection Physics = #Physics.ThisObject Physics.Object.CornerPosGlobal.0.x run function physics:zprivate/contact_generation/new_contact/world/world_axis_x/get_corner {Corner:0}
    execute if score #Physics.DeepestProjection Physics = #Physics.ThisObject Physics.Object.CornerPosGlobal.1.x run function physics:zprivate/contact_generation/new_contact/world/world_axis_x/get_corner {Corner:1}
    execute if score #Physics.DeepestProjection Physics = #Physics.ThisObject Physics.Object.CornerPosGlobal.2.x run function physics:zprivate/contact_generation/new_contact/world/world_axis_x/get_corner {Corner:2}
    execute if score #Physics.DeepestProjection Physics = #Physics.ThisObject Physics.Object.CornerPosGlobal.3.x run function physics:zprivate/contact_generation/new_contact/world/world_axis_x/get_corner {Corner:3}
    execute if score #Physics.DeepestProjection Physics = #Physics.ThisObject Physics.Object.CornerPosGlobal.4.x run function physics:zprivate/contact_generation/new_contact/world/world_axis_x/get_corner {Corner:4}
    execute if score #Physics.DeepestProjection Physics = #Physics.ThisObject Physics.Object.CornerPosGlobal.5.x run function physics:zprivate/contact_generation/new_contact/world/world_axis_x/get_corner {Corner:5}
    execute if score #Physics.DeepestProjection Physics = #Physics.ThisObject Physics.Object.CornerPosGlobal.6.x run function physics:zprivate/contact_generation/new_contact/world/world_axis_x/get_corner {Corner:6}
    execute if score #Physics.DeepestProjection Physics = #Physics.ThisObject Physics.Object.CornerPosGlobal.7.x run function physics:zprivate/contact_generation/new_contact/world/world_axis_x/get_corner {Corner:7}
...
# Calculate Penetration Depth, Contact Normal, Contact Point & Separating Velocity
    ...
    # (Important): Because the static object is now the one with the face, the result of the separating velocity is inverted.
        ...
        execute if score #Physics.FeatureB Physics matches 11 run scoreboard players operation #Physics.PointVelocity.x Physics *= #Physics.Constants.-1 Physics
