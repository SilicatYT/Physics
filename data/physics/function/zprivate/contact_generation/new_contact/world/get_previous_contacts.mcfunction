...
# (Important): Because this function can also be run if there is no data for that block, the "data.Block" storage would keep the previous data, leading to bugs. So it's cleared preemptively.
