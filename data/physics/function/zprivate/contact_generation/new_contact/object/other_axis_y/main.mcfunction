...
execute if score #Physics.ObjectB.Feature Physics matches 102 run scoreboard players operation #Physics.DeepestProjection Physics = #Physics.Projection.Object.OtherObjectAxis.y.Max Physics
execute if score #Physics.ObjectB.Feature Physics matches 103 run scoreboard players operation #Physics.DeepestProjection Physics = #Physics.Projection.Object.OtherObjectAxis.y.Min Physics
    ...
    execute if score #Physics.ObjectB.Feature Physics matches 103 run scoreboard players operation #Physics.DeepestProjection Physics *= #Physics.Constants.-1 Physics

    execute if score #Physics.DeepestProjection Physics = #Physics.Projection.ObjectCorner0.OtherObjectAxis.y Physics run function physics:zprivate/contact_generation/new_contact/object/other_axis_y/get_corner {Corner:7}
    execute if score #Physics.DeepestProjection Physics = #Physics.Projection.ObjectCorner1.OtherObjectAxis.y Physics run function physics:zprivate/contact_generation/new_contact/object/other_axis_y/get_corner {Corner:6}
    execute if score #Physics.DeepestProjection Physics = #Physics.Projection.ObjectCorner2.OtherObjectAxis.y Physics run function physics:zprivate/contact_generation/new_contact/object/other_axis_y/get_corner {Corner:5}
    execute if score #Physics.DeepestProjection Physics = #Physics.Projection.ObjectCorner3.OtherObjectAxis.y Physics run function physics:zprivate/contact_generation/new_contact/object/other_axis_y/get_corner {Corner:4}
    execute if score #Physics.DeepestProjection Physics = #Physics.Projection.ObjectCorner4.OtherObjectAxis.y Physics run function physics:zprivate/contact_generation/new_contact/object/other_axis_y/get_corner {Corner:3}
    execute if score #Physics.DeepestProjection Physics = #Physics.Projection.ObjectCorner5.OtherObjectAxis.y Physics run function physics:zprivate/contact_generation/new_contact/object/other_axis_y/get_corner {Corner:2}
    execute if score #Physics.DeepestProjection Physics = #Physics.Projection.ObjectCorner6.OtherObjectAxis.y Physics run function physics:zprivate/contact_generation/new_contact/object/other_axis_y/get_corner {Corner:1}
    execute if score #Physics.DeepestProjection Physics = #Physics.Projection.ObjectCorner7.OtherObjectAxis.y Physics run function physics:zprivate/contact_generation/new_contact/object/other_axis_y/get_corner {Corner:0}
