...
$scoreboard players operation #Physics.ObjectA.EdgeProjection Physics = #Physics.Projection.ObjectCorner$(StartCorner).CrossProductAxis2.zz Physics
scoreboard players operation #Physics.ObjectA.EdgeProjection Physics += #Physics.Projection.ObjectCenter.CrossProductAxis2.zz Physics
