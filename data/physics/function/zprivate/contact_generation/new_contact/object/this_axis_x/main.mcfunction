...
scoreboard players operation #Physics.DeepestProjection Physics = #Physics.Projection.OtherObject.ObjectAxis.x.Max Physics
    ...
    execute if score #Physics.ObjectA.Feature Physics matches 100 run function physics:zprivate/contact_generation/new_contact/object/this_axis_x/check_corner_max
    execute if score #Physics.ObjectA.Feature Physics matches 101 run function physics:zprivate/contact_generation/new_contact/object/this_axis_x/check_corner_min
