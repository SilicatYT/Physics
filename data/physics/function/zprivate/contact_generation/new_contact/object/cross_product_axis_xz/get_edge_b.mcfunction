...
$scoreboard players operation #Physics.ObjectB.EdgeProjection Physics = #Physics.Projection.OtherObjectCorner$(StartCorner).CrossProductAxis2.xz Physics
scoreboard players operation #Physics.ObjectB.EdgeProjection Physics += #Physics.Projection.OtherObjectCenter.CrossProductAxis2.xz Physics
...
scoreboard players operation #Physics.ContactNormal.x Physics = #Physics.CrossProductAxis2.xz.x Physics
scoreboard players operation #Physics.ContactNormal.y Physics = #Physics.CrossProductAxis2.xz.y Physics
scoreboard players operation #Physics.ContactNormal.z Physics = #Physics.CrossProductAxis2.xz.z Physics
