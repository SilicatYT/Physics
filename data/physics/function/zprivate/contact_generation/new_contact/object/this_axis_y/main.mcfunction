...
scoreboard players operation #Physics.DeepestProjection Physics = #Physics.Projection.OtherObject.ObjectAxis.y.Max Physics
    ...
    execute if score #Physics.ObjectA.Feature Physics matches 102 run function physics:zprivate/contact_generation/new_contact/object/this_axis_y/check_corner_max
    execute if score #Physics.ObjectA.Feature Physics matches 103 run function physics:zprivate/contact_generation/new_contact/object/this_axis_y/check_corner_min
