...
execute if score #Physics.Projection.Object.OtherObjectAxis.x.Min Physics < #Physics.ThisObject Physics.Object.ProjectionOwnAxis.x.Min store result storage physics:temp data.NewContact.FeatureB byte 1 store result storage physics:temp data.FeatureB byte 1 run scoreboard players set #Physics.FeatureB Physics 10
execute if score #Physics.Projection.Object.OtherObjectAxis.x.Min Physics >= #Physics.ThisObject Physics.Object.ProjectionOwnAxis.x.Min store result storage physics:temp data.NewContact.FeatureB byte 1 store result storage physics:temp data.FeatureB byte 1 run scoreboard players set #Physics.FeatureB Physics 11
