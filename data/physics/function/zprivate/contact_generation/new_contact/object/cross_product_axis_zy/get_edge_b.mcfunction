...
$scoreboard players operation #Physics.ObjectB.EdgeProjection Physics = #Physics.Projection.OtherObjectCorner$(StartCorner).CrossProductAxis2.zy Physics
scoreboard players operation #Physics.ObjectB.EdgeProjection Physics += #Physics.Projection.OtherObjectCenter.CrossProductAxis2.zy Physics
...
scoreboard players operation #Physics.ContactNormal.x Physics = #Physics.CrossProductAxis2.zy.x Physics
scoreboard players operation #Physics.ContactNormal.y Physics = #Physics.CrossProductAxis2.zy.y Physics
scoreboard players operation #Physics.ContactNormal.z Physics = #Physics.CrossProductAxis2.zy.z Physics
