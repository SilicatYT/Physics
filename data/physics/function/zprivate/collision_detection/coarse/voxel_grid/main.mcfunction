...
scoreboard players operation #Physics.Maths.BlockPos.x Physics.Value -= @s Physics.Object.BoundingBoxHalvedPositive.x
scoreboard players operation #Physics.Maths.BlockPos.y Physics.Value -= @s Physics.Object.BoundingBoxHalvedPositive.y
scoreboard players operation #Physics.Maths.BlockPos.z Physics.Value -= @s Physics.Object.BoundingBoxHalvedPositive.z
