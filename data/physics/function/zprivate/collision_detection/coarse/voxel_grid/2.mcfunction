...
# TODO: Do the "2" checks at the end, or group them together so I can easily do a single check to just not run them if the boundary is reached for either one of the axes
    # Layer 1
