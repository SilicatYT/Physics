...
execute store result score #Physics.RayIntersection.t0 Physics run scoreboard players operation #Physics.Maths.Value1 Physics /= #Physics.RayDirectionOriginal.x Physics
