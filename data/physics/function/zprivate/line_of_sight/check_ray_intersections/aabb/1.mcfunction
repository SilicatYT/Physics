...
execute store result score #Physics.RayIntersection.t1 Physics run scoreboard players operation #Physics.Maths.Value1 Physics /= #Physics.RayDirectionOriginal.x Physics
