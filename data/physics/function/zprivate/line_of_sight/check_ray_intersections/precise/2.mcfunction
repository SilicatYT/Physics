...
execute store result score #Physics.RayIntersection.t2 Physics run scoreboard players operation #Physics.Maths.Value1 Physics /= #Physics.RayDirectionLocal.y Physics
...
execute if score #Physics.Maths.Value1 Physics matches -500000..500000 if score #Physics.RayIntersection.t2 Physics < #Physics.MinDistance Physics run scoreboard players operation #Physics.MinDistance Physics = #Physics.RayIntersection.t2 Physics
