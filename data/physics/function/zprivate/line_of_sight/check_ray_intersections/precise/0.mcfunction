...
execute store result score #Physics.RayIntersection.t0 Physics run scoreboard players operation #Physics.Maths.Value1 Physics /= #Physics.RayDirectionLocal.x Physics
...
# Step 3: Calculate the point of intersection for the other two axes: origin + t * direction
    ...
    # z
    scoreboard players operation #Physics.Maths.Value1 Physics = #Physics.RayIntersection.t0 Physics
...
execute if score #Physics.Maths.Value1 Physics matches -500000..500000 if score #Physics.RayIntersection.t0 Physics < #Physics.MinDistance Physics run scoreboard players operation #Physics.MinDistance Physics = #Physics.RayIntersection.t0 Physics
