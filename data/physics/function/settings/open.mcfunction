...
execute store result storage physics:temp data.Settings.Resolution_MinPenetrationDepth short 1 run scoreboard players get #Physics.Settings.Accumulation.MinPenetrationDepth Physics
execute store result storage physics:temp data.Settings.Resolution_MaxSeparatingVelocity short 1 run scoreboard players get #Physics.Settings.Accumulation.MinPenetrationDepth Physics
