...
# TP
execute store result storage physics:zprivate util.get_magnitude.Pos[0] double 1 run scoreboard players get #get_magnitude.x val
execute store result storage physics:zprivate util.get_magnitude.Pos[1] double 1 run scoreboard players get #get_magnitude.y val
execute store result storage physics:zprivate util.get_magnitude.Pos[2] double 1 run scoreboard players get #get_magnitude.z val
data modify entity 0-0-0-0-0 Pos set from storage physics:zprivate util.get_magnitude.Pos
rotate 0-0-0-0-0 facing 0.0 0.0 0.0
execute store result storage physics:zprivate util.get_magnitude.t int 1 run data get entity 0-0-0-0-0 Rotation[1] 100

# Trig
function physics:zprivate/util/get_magnitude/sine with storage physics:zprivate util.get_magnitude
